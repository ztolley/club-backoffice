...
<body>
    <div class="container">
        ...
        <form method="POST" action="{{ route('player.application.submit') }}" onsubmit="return submitForm()"
            ...
            <div class="forms-container">
                <div class="forms-fields-container">
                    ...
                    <x-text-field label="Applicable Age Groups (25/26)" name="age_groups"
                        value="{{ old('age_groups') }}" :required="false"
                        description="U10,11,12,13,14,15,16,18 or open age" />
                    ...
                    <x-text-area label="Additional Comments" name="additional_info"
